...
export const GenericTable = ({columns, useData, defaultPageSize, filter}: GenericTableProps) => {
    ...
    console.log("filter: ", filter, "columns: ", columns,"useData: ", useData, "defaultPageSize: ", defaultPageSize)
    ...
    const { data, error, refetch } = useGetRecordsQuery({filter, lastEvaluatedKey});
    ...
    useEffect(() => {
        refetch();
    }, [filter, lastEvaluatedKey, refetch]);
        ...
        <Card.Body className="pt-0">
          ...
          <Card.Footer
            ...
            <Pagination className="mb-2 mb-lg-0">
                <Pagination.Prev
                disabled={!data || data.data.lastEvaluatedKey != null}
                onClick={() => {
                ...
                onClick={() => {
                    setLastEvaluatedKey(data.data.lastEvaluatedKey); // set to the key of the next page
                    nextPage();
                }}
                />
            </Pagination>
